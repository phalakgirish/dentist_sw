...
<div class="rightpanel">
        ...
        <div class="maincontent">
			...
			<div class="widgetbox">
			 <h4 class="widgettitle">Income Report</h4>
						
             

				  <div class="widgetcontent nopadding">
                    <form class="stdform stdform2" method="post" action="<?php echo base_url()."index.php/reports/income_reportaction"?>" id='get_appointment'>
							  <div class="par">
