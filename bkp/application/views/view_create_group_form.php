...
<div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="widgetbox box-inverse">
                <h4 class="widgettitle">Create New Group</h4>
                      ...
                      <form id="form1" class="stdform" >
						<div class="par control-group" id='error_span'>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
								<input type="text" name="group_name" id="group_name" class="input-large" />
								</div>
							</div>	
							...
							<input type="button" class="btn btn-primary" id="group_register_btn" value='Submit'>
