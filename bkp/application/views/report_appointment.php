...
<div class="rightpanel">
        ...
        <div class="maincontent">
			...
			<div class="widgetbox">
			 <h4 class="widgettitle">Appointment Report</h4>
						
             

				  <div class="widgetcontent nopadding">
                    <form class="stdform stdform2" method="post" action="<?php echo base_url()."index.php/reports/get_appointment"?>" id='get_appointment'>
							  <div class="par">
