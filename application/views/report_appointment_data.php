...
<form method="post" action="<?php echo base_url()."index.php/reports/export_appointment"; ?>">
						<input type="hidden" name="app_from" value="<?php echo $app_from; ?>"><input type="hidden" name="app_to" value="<?php echo $app_to; ?>">
						
						<input type='submit' id='export_ledger' class="btn btn-primary" value='Export to excel'> 
						</form>	
                        <h5 class="subtitle">Appointment Data</h5><br />
						<?php
                        ...
                        <col class="con1" />
                            ...
                            <tbody>
								<?php
                                    ...
                                    <td><?php echo $patient_details->patient_contact; ?></td>
