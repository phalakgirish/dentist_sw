...
$quote_data=$this->myclass->select("quote_id,quote_no,quote_date,quote_name,quote_mobileno,quote_des,quote_price,quote_sub,quote_dis,quote_tot","bs_quote","quote_no='$edit_id'");
            ...
            <div class="widgetbox ">
				<div class="row-fluid">    
                    <div class="span6">
						...
						<form class="stdform stdform2" method='post' action='<?php echo base_url()?>index.php/patient/quotation_editaction'>
					<table class="table table-bordered table-invoice">
					<input type='hidden' value='<?php echo $edit_id?>' name='quote_no'/>
                            <tr>
                                <td class="width30">Quotation No.:</td>
                                <td class="width70"><strong><?php echo $edit_id; ?></strong></td>
                            </tr>
							<tr>
            ...
            <table class="table table-bordered table-invoice-full">
				...
				<?php
                    ...
                    if(is_array($quote_data) && !empty($quote_data))
					 ...
					 <tr>
                        <td><?php echo $a;?></td>
                        <td><textarea cols="80" rows="5" name="quote_des[]" id="quote_des-<?php echo $i;?>" class="span5 quote_des"><?php echo $quote->quote_des;?></textarea></td>
                        <td class="right"><strong><input type="text" name="quote_price[]" value='<?php echo $quote->quote_price;?>' id="quote_price-<?php echo $i;?>" class="input-small quote_price" /></strong></td>
                    </tr>
