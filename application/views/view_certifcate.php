...
$prescribe=$this->myclass->select("drags_name,prescription_strength,prescription_strength_unit,prescription_duration,prescription_duration_unit,prescription_moring,prescription_noon,prescription_night,prescription_instruction,dragstype_name","bs_drags, bs_prescription,bs_drags_type","prescription_patient_id='$view_patientid' AND prescription_drugid=drags_id AND dragstype_id=drags_type");
...
<div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="widgetbox">
			<h4 class="widgettitle">Certifcate</h4>
			<div id="divToPrint" >
			  ...
			  <!--
                ...
                <div class="topic-content" style="margin-top:100px;">
					...
					<hr/>
					<!--<center><h3><u>Good Health Certificate</u></h3></center>-->
					...
					<br/>
						<center><h3><u>To Whomever It May Concern</u></h3></center>
						<br/><br/>
						<h4>
							This is to certify that <?php echo $patient_name; ?> is our patient. He/she has been examined and treated for his/her dental and oral problem/pathology. He/she is having no active dental or oral health problem.
