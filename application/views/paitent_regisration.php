    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="widgetbox">
                ...
                <h4 class="widgettitle">New Patient</h4>
                <div class="widgetcontent nopadding">
					...
					<div class="par control-group" id='error_span'>
                            ...
                            <p><input type="hidden" name="patient_staff_id" value="<?php echo $staff_id; ?>" id="patient_staff_id" class="input-xxlarge" />
							<input type="hidden" name="appo_staff_id" value="<?php echo $staff_id; ?>" id="appo_staff_id" class="input-xxlarge" />
                                <label>Name</label>
                                <span class="field"><input type="text" name="patient_name" id="patient_name" value="<?php echo set_value();?>" class="input-xxlarge" /></span>
                            </p>
							<p>
                                <label>Mobile</label>
                                <span class="field"><input type="text" name="patient_contact" id="patient_contact" class="input-xxlarge" /></span>
                            </p>
							<p>
                        ...
                        <div class="par">
                            ...
                            <span class="field"><input type="checkbox" checked='checked' value='sms' name="sendsms">SMS Sent</span>
								
			    </div>
                       
						<p class="stdformbutton">
                                <button type='button' class="btn btn-primary" id='btn_get_appointment'>Submit</button>
