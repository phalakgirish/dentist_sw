...
<div class="rightpanel">
        ...
        <div class="maincontent">
            ...
            <div class="widgetbox box-inverse">
                <h4 class="widgettitle">Add Inwards</h4>
                      ...
                      <form id="form1" class="stdform" >
						<div class="par control-group" id='error_span'>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                <input type="text" name="invt_podate" id="datepicker" class="input-large" />
                                </div>
                            </div>  
                            <div class="control-group">
                                <label class="control-label" for="username">No of Unit</label>
                                <div class="controls">
                                <input type="text" name="invt_unit" id="invt_unit" class="input-large" />
                                </div>
                            </div>  
                            <div class="control-group">
                                <label class="control-label" for="username">Quantity</label>
                                <div class="controls">
                                <input type="text" name="invt_qty" id="invt_qty" class="input-large" />
                                </div>
                            </div>  
                            <div class="control-group">
                                <label class="control-label" for="username">Rate</label>
                                <div class="controls">
                                <input type="text" name="invt_rate" id="invt_rate" class="input-large" />
                                </div>
                            </div>  
                            <div class="control-group">
                                <label class="control-label" for="username">Amount</label>
                                <div class="controls">
                                <input type="text" name="invt_amt" id="invt_amt" class="input-large" />
                                </div>
                            </div>  
							
                            
							<p class="stdformbutton">
							<input type="button" class="btn btn-primary" id="item_register_btn" value='Submit'>
