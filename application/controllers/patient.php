...
class Patient extends CI_Controller {
	...
	public function appointment_action()
	{
		...
		if($day_time[0]->checktime !=0 || $evening_time[0]->checktime !=0)
		{
			...
			if($appointment_count[0]->today_appointment == 0)
			{
				...
				$message_data="Dear%20$greeting%20$patient_name,%20We%20confirm%20your%20appointment%20dated%2$appdate%20$appointment_time.%20Best%20Regards-Dr.Saluja%20Dental%20Care%20 for assistance please call us on 9987523711,022-24445273";
	...
	function appointment_edit_action()
	{
		...
		if($ans['appo_status']=="2")
		{
				...
				$appdate=date("d-M-y",strtotime($date));
				$message_data="Dear%20$greeting%20$patient_name,%20 as per your request we%20cancel%20your%20appointment%20dated%20$appdate%20$appointment_time.%20Best%20Regards-Dr.Saluja%20Dental%20Care%20 for assistance please call us on 9987523711,022-24445273";	
				//$message_data='Hello';
				$message=str_replace(" ","%20",$message_data);
				//echo "<pre>"
				//print_r($message);
		...
		if($day_time[0]->checktime !=0 || $evening_time[0]->checktime !=0)
		{
			...
			if($appointment_count[0]->today_appointment == 0)
			{
				...
				$message_data="Dear%20$greeting%20$patient_name,%20 as per your request we%20reschedule%20your%20appointment%20dated%20$appdate%20$appointment_time.%20Best%20Regards-Dr.Saluja%20Dental%20Care%20 for assistance please call us on 9987523711,022-24445273";	
				//$message_data='Hello';
				$message=str_replace(" ","%20",$message_data);
				//echo "<pre>"
				//print_r($message);
	...
	function existing_patient_appointment_action()
	{
		...
		if($day_time[0]->checktime !=0 || $evening_time[0]->checktime !=0)
		{
			...
			if($appointment_count[0]->today_appointment == 0)
			{
				...
				$mobile=$ans['patient_contact'];
				$appdate=date("d-M-y",strtotime($date));
		$message_data="Dear%20 $greeting %20$patient_name,%20We%20confirm%20your%20appointment%20dated%20.$appdate%20$appointment_time.%20Best%20Regards-Dr.Saluja%20Dental%20Care%20 for assistance please call us on 9987523711,022-24445273";	
		//$message_data='Hello';
		$message=str_replace(" ","%20",$message_data);
		//echo "<pre>"
		//print_r($message);
